...
(4, 'SISTEMA PARA FARMACIAS', 'SISTEMA PARA FARMACIAS DESARROLLADO CON PHP ', 'El sistema de Inventario para farmacias es un software de oficina de farmacia, que cuenta con un dise̱o moderno de respuesta ideal para cualquier tipo de negocio de farmacia.', 'sis_farma.jpeg', 'https://obedalvarado.pw/blog/sistema-web-inventario-medicamentos-php-mysql/', 1, 6);
